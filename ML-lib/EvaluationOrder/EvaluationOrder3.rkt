...
;;Like EvalOrder 2, uses lambda for laziness
...
;The major difference is that let bindings are strict. It's only
;function applications that are lazy in this language.
